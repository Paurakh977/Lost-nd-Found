    ...
    <main className="flex-1 flex flex-col items-center justify-center p-6 md:p-12">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-800 mb-6">About GOTUS</h1>
        ...
        <div className="bg-blue-50 p-8 rounded-lg border border-blue-200">
          <h2 className="text-2xl font-semibold text-blue-800 mb-6">Why Choose GOTUS?</h2>
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-blue-800 mb-2">Fast Results</h3>
              <p className="text-blue-700">
