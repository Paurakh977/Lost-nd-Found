    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      >
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-semibold text-gray-900 dark:text-white">My Resolved Cases</h1>
            <p className="text-sm text-gray-600 dark:text-gray-400">Cases you have successfully resolved</p>
          </div>
        </div>
      </motion.div>
