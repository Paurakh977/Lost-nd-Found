      ...
      >
        <div className="bg-white/70 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 p-8 relative overflow-hidden">
          ...
          <div className="text-center mb-8 select-none relative">
            <motion.div 
              className="w-32 h-32 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-2xl mx-auto mb-6 flex items-center justify-center shadow-lg"
            ...
            >
              ...
              <span className="bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent font-bold">GOTUS</span>
            </motion.h1>
            <motion.p 
          ...
          >
            ...
            >
              <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none z-10">
                <Mail className={`h-5 w-5 transition-colors duration-200 ${
                  email ? 'text-indigo-500' : 'text-slate-400'
                }`} />
              </div>
              <input
                type="email"
                ...
                className={`w-full pl-12 pr-4 py-4 border-2 rounded-2xl bg-white/50 backdrop-blur-sm focus:ring-4 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all duration-300 ${
            ...
            >
              <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none z-10">
                <Lock className={`h-5 w-5 transition-colors duration-200 ${
                  password ? 'text-indigo-500' : 'text-slate-400'
                }`} />
              </div>
              <input
                ...
                className={`w-full pl-12 pr-14 py-4 border-2 rounded-2xl bg-white/50 backdrop-blur-sm focus:ring-4 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all duration-300 ${
            ...
            >
              <label className="flex items-center cursor-pointer group">
                <input
                  type="checkbox"
                  className="rounded border-2 border-slate-300 text-indigo-600 focus:ring-indigo-500 focus:ring-offset-0 h-4 w-4 transition-colors duration-200"
                />
                <span className="ml-3 text-slate-600 font-medium tracking-wide group-hover:text-slate-800 transition-colors duration-200">Remember me</span>
              </label>
              <motion.a 
                href="#" 
                className="text-indigo-600 hover:text-indigo-700 transition-colors font-medium tracking-wide"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                transition={{ duration: 0.1 }}
              >
            ...
            <motion.button
              type="submit"
              disabled={isLoading}
              className="w-full bg-gradient-to-r from-indigo-600 to-purple-600 text-white py-4 px-6 rounded-2xl font-semibold tracking-wide text-base disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300 relative overflow-hidden group shadow-xl"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ 
                duration: 0.4, 
            ...
            >
              ...
              <div className="relative flex justify-center text-xs">
                <span className="px-4 bg-white/70 backdrop-blur-sm text-slate-500 font-medium tracking-wider uppercase">or continue with</span>
              </div>
            </motion.div>
          ...
          <div className="grid grid-cols-3 gap-4 mt-6">
            ...
            >
              <span className="absolute inset-0 w-0 bg-gradient-to-r from-indigo-500 to-purple-500 transition-all duration-300 ease-out group-hover:w-full"></span>
          ...
          >
            <p className="text-sm text-slate-600 font-medium tracking-wide">
              ...
              <Link
                href="/sign-up" 
                className="text-indigo-600 hover:text-indigo-700 font-semibold tracking-wide transition-colors duration-200"
              >
                Sign up
              </Link>
            </p>
